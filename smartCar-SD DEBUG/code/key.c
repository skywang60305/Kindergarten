...
volatile KEY_MSG_t keymsg = {KEY_R, KEY_UP};  //按键消息结构体
gpio_pin_enum KEY_PTxn[KEY_MAX] = {P20_6 , P20_7, P11_2, P11_3, P20_8, P20_9};
//学习板五向开关引脚
//P10_3 LEFT    P10_1 RIGHT    P20_3 UP    P20_0 DOWN   P02_5 MID
//gpio_pin_enum KEY_PTxn[KEY_MAX] = {P20_10, P20_8, P20_6, P20_7, P20_9, P20_14, P15_4};
//P20_6  R
//P20_7  U
//P20_10 L
//P20_14 D
...
{
    KEY_e   keynum;
    static uint8 keytime[KEY_MAX] = {0};                          //静态数组，保存各数组按下时间
...
{
//     if(keymsg.key==KEY_L)
//     tft180_show_string(80,80,"KEY_L");
//     if(keymsg.key==KEY_R)
//     tft180_show_string(80,80,"KEY_R");
//     if(keymsg.key==KEY_U)
//     tft180_show_string(80,80,"KEY_U");
//     if(keymsg.key==KEY_D)
//     tft180_show_string(80,80,"KEY_D");
//     if(keymsg.key==KEY_B)
//     tft180_show_string(80,80,"KEY_B");
//     if(keymsg.status == KEY_UP)
//     tft180_show_string(80,100,"KEY_UP");
//     else
//     tft180_show_string(80,100,"KEY_DOWN");
}
