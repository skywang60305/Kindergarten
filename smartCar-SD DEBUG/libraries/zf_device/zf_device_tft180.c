...
static uint8                    tft180_x_max        = 160;                              // 屏幕X轴像素最大值
static uint8                    tft180_y_max        = 128;                              // 屏幕Y轴像素最大值
...
//-------------------------------------------------------------------------------------------------------------------
void lcd_drawBlock (uint16 x1, uint16 y1, uint16 x2, uint16 y2, const uint16 color)
{
    TFT180_CS(0);
    tft180_set_region(x1, y1, x2-1, y2-1);
