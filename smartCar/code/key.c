...
#include "key.h"
extern volatile uint8 ExitMenu_flag;
extern volatile uint8 showDirFlag;

volatile KEY_MSG_t keymsg = {KEY_B, KEY_UP}; // 按键消息结构体
// gpio_pin_enum KEY_PTxn[KEY_MAX] = {P11_2, P11_9, P13_3, P11_3, P11_6, P33_5, P33_4}; //小主板
gpio_pin_enum KEY_PTxn[KEY_MAX] = {P20_10, P20_8, P20_6, P20_7, P20_9, P15_6, P15_4};
/*
