...
#define     WHITE    RGB565_WHITE                                                       // 白色
#define     BLACK    RGB565_BLACK                                                       // 黑色
#define     BLUE     RGB565_BLUE                                                        // 蓝色
#define     PURPLE   RGB565_PURPLE                                                      // 紫色
#define     PINK     RGB565_PINK                                                        // 粉色
#define     RED      RGB565_RED                                                         // 红色
#define     MAGENTA  RGB565_MAGENTA                                                     // 品红
#define     GREEN    RGB565_GREEN                                                       // 绿色
#define     CYAN     RGB565_CYAN                                                        // 青色
#define     YELLOW   RGB565_YELLOW                                                      // 黄色
#define     BROWN    RGB565_BROWN                                                       // 棕色
#define     GRAY     RGB565_GRAY            
#define     OLIVE    0x7BE0                                                             //橄榄绿
#define     MANGENTA 0xF800                                                             //品红
#define     TFT_X_MAX   tft180_width_max
#define     TFT_Y_MAX   tft180_height_max

//#define     lcd_showstr(x,y,dat)                    (tft180_show_string(x,y,dat))
//#define     lcd_showfloat(x,y,dat,num,pointnumx)    (tft180_show_float(x,y,dat,num,pointnumx))
//#define     tft180_write_16bit_data(data)           (spi_write_16bit(TFT180_SPI, (data)))

#define     lcd_clear_all(color)                    tft180_full(color)
//#define     lcd_set_region( x1,  y1,  x2,  y2)      tft180_set_region( x1,  y1,  x2,  y2)
