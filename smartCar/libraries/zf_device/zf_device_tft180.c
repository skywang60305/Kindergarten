...
static 	uint16                   tft180_pencolor     = TFT180_DEFAULT_PENCOLOR;          // 画笔颜色(字体色)
static 	uint16                   tft180_bgcolor      = TFT180_DEFAULT_BGCOLOR;           // 背景颜色

static 	tft180_dir_enum          tft180_display_dir  = TFT180_DEFAULT_DISPLAY_DIR;       // 显示方向
...
//-------------------------------------------------------------------------------------------------------------------
// 函数简介     TFT180 软件 SPI 写 8bit 数据数组
// 参数说明     *data           数据
// 参数说明     len             数据长度
// 返回参数     void
...
//-------------------------------------------------------------------------------------------------------------------
// 函数简介     TFT180 软件 SPI 写 16bit 数据数组
// 参数说明     *data           数据
// 参数说明     len             数据长度
// 返回参数     void
...
// 备注信息     内部调用
//-------------------------------------------------------------------------------------------------------------------
void tft180_set_region (uint16 x1, uint16 y1, uint16 x2, uint16 y2)
{
...
// 参数说明     width           图像实际宽度
// 参数说明     height          图像实际高度
// 参数说明     dis_width       图像显示宽度 参数范围 [0, tft180_width_max]
// 参数说明     dis_height      图像显示高度 参数范围 [0, tft180_height_max]
// 返回参数     void
...
// 参数说明     dis_width       波形显示宽度 参数范围 [0, tft180_width_max]
// 参数说明     dis_value_max   波形显示最大值 参数范围 [0, tft180_height_max]
// 返回参数     void
...
{
    tft180_set_region ( x1,  y1,  x2,  y2);
}
void lcd_showint8(uint16 x, uint16 y, const int8 dat)
{
    int num=3;//显示位数
    tft180_show_int(x,y*16,dat,num);
}
void lcd_showint16(uint16 x, uint16 y, const int8 dat)
{
    int num=3;//显示位数
    tft180_show_int(x,y*16,dat,num);
}
void lcd_showint32(uint16 x, uint16 y, const int dat)
{
    int num=3;//显示位数
    tft180_show_int(x,y*16,dat,num);
}
void lcd_showuint8(uint16 x, uint16 y, const int8 dat)
{
    int num=3;//显示位数
    tft180_show_int(x,y*16,dat,num);
}
void lcd_showuint16(uint16 x, uint16 y, const int8 dat)
{
    int num=3;//显示位数
    tft180_show_int(x,y*16,dat,num);
}
void lcd_showuint32(uint16 x, uint16 y, const int8 dat)
{
    int num=3;//显示位数
    tft180_show_int(x,y*16,dat,num);
}
...
void lcd_clear(uint8 x_start, uint8 y_start, uint8 x_end, uint8 y_end, uint16 color)
{
    uint8 i,j;
    TFT180_CS(0);
    tft180_set_region(x_start, y_start, x_end, y_end);
...
//字符串显示函数
void m_lcd_showstr(uint16 x,uint16 y, const char dat[],const uint16 pen, const  uint16 bgcolor)
{
    tft180_set_color(pen,bgcolor);
    tft180_show_string(x,y,dat);
}
//浮点数显示函数
void m_lcd_showfloat(uint16 x, uint16 y, uint16 pen, uint16 bgcolor, double dat,uint8 num,uint8 pointnum)
{
    tft180_set_color(pen,bgcolor);
    tft180_show_float (x,y,dat,num,pointnum);
}
//int类型函数
//void m_lcd_showint8(uint16 x,uint16 y, const int32 dat,const uint16 pen, const  uint16 bgcolor)
//{
//    int num=3;//显示位数
//    tft180_set_color(pen,bgcolor);
//    tft180_show_int(x,y,dat,num);
//}
//void m_lcd_showint16(uint16 x,uint16 y, const int32 dat,const uint16 pen, const  uint16 bgcolor)
//{
//    int num=3;//显示位数
//    tft180_set_color(pen,bgcolor);
//    tft180_show_int(x,y,dat,num);
//}
//void m_lcd_showint32(uint16 x,uint16 y, const int32 dat,const uint16 pen, const  uint16 bgcolor,uint8 num)
//{
//    tft180_set_color(pen,bgcolor);
//    tft180_show_int(x,y,dat,num);
//}
////uint类型函数
//void m_lcd_showuint8(uint16 x,uint16 y, const int32 dat,const uint16 pen, const  uint16 bgcolor)
//{
//    int num=3;//显示位数
//    tft180_set_color(pen,bgcolor);
//    tft180_show_uint(x,y,dat,num);
//}
//void m_lcd_showuint16(uint16 x,uint16 y, const int32 dat,const uint16 pen, const  uint16 bgcolor)
//{
//    int num=3;//显示位数
//    tft180_set_color(pen,bgcolor);
//    tft180_show_uint(x,y,dat,num);
//}
//void m_lcd_showuint32(uint16 x,uint16 y, const int32 dat,const uint16 pen, const  uint16 bgcolor,uint8 num)
//{
//    tft180_set_color(pen,bgcolor);
//    tft180_show_uint(x,y,dat,num);
//}
void lcd_showstr(uint16 x, uint16 y, const char dat[])
{
    tft180_show_string(x,y*16,dat);
}
void lcd_showfloat(uint16 x, uint16 y, const double dat, uint8 num, uint8 pointnum)
{
    tft180_show_float(x,y,dat,num,pointnum);
}
//
